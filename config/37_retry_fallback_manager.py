...
class RetryFallbackLLMManager:
    ...
    def _try_provider(self, provider, llm, prompt):
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("ZYRA LUXE - RETRY + FALLBACK MANAGER")
    print("=" * 60)
    ...
    manager = RetryFallbackLLMManager(
        config,
        error_classifier
    )
    ...
    print()
    print("=" * 60)
    print("RETRY + FALLBACK CHECK COMPLETED")
    print("=" * 60)